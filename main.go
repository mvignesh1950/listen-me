...
import (
	...
	"github.com/mvignesh1950/listen-me/graceful"
	"github.com/mvignesh1950/listen-me/watcher"
)
...
func init() {
	...
	flag.Usage = func() {
		fmt.Fprintf(os.Stderr, "Usage: listen-me [options]\n")
